    ...
    <main>
      ...
      <section className="relative min-h-[78vh] flex items-center justify-center overflow-hidden">
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              address: {
                '@type': 'PostalAddress',
                streetAddress: 'Patriotsesteenweg 67',
                addressLocality: 'Pajottegem', // Or Hernes/Enghien based on context
                postalCode: '1540',
                addressCountry: 'BE'
              },
              geo: {
                '@type': 'GeoCoordinates',
                latitude: 50.725, // Approx, should be verified ideally but good for template
                longitude: 4.05
              },
        ...
        <div className="relative z-10 text-center text-white px-4 animate-fade-in max-w-3xl mx-auto">
          ...
          <h1 className="text-lg md:text-2xl font-medium text-white/90 mb-8 animate-fade-in-delayed">
            {t.hero.subtitle}
          </h1>
            ...
            <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-orange-700 dark:text-orange-300">{t.exceptionalClosure.date}</p>
                </div>
              </div>
            </div>
          </Reveal> */}
